...
function getProfileLS() {
  if (localStorage.profiles) {
    ...
    // return profilesFromLS; ONLY IF GENERIC OBJ IS NEEDED INSTEAD OF PROFILE OBJ
    for (let i = 0; i < profilesFromLS.length; i++) {
      new Profile(profilesFromLS[i].name, profilesFromLS[i].age, profilesFromLS[i].pronoun);
    }
  }
...
//TODO stringify in handleStorySubmit
